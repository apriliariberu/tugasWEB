      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-12">
                <h1 class="m-0 text-black text-center">Silahkan Pilih Produk Elektronik Favorit Mu</h1>
        ...
        <div class="container">
          ...
          <div class="row mt-3">
            ...
            $query = mysqli_query($koneksi, 'SELECT * FROM produk WHERE jenis_menu="Elektronik";');
